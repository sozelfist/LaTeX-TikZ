...
\begin{document}
    ...
    \begin{tikzpicture}[line cap=round, line join=round]
        ...
        % draw ions
        \node[draw=white, circle, fill=black!25, inner sep=0pt] at (1, 1) {\tiny\ce{Cu^2+}};
        \node[draw=white, circle, fill=blue!60, inner sep=0pt] at (4, 1.25) {\tiny\ce{Zn^2+}};
        \node[draw=white, circle, fill=black!25, inner sep=0pt] (e1) at (0.5, 2) {\tiny\ce{e^-}};
        \node[draw=white, circle, fill=blue!60, inner sep=0pt] (e2) at (4.75, 2.25) {\tiny\ce{e^-}};
        % draw texts
